...
export default function ReturnsPage() {
  ...
  return <div className={styles.page}><PageHeader eyebrow="Pengembalian fasilitas" title="Pengembalian" description="Kirim bukti kondisi barang paling lambat pada tanggal akhir peminjaman." /><RequestList requests={returns} detailBase="/peminjam/pengembalian" emptyTitle="Tidak ada pengembalian" empty="Tidak ada barang yang perlu dikembalikan saat ini." emptyAction={<Link className={`${styles.linkButton} ${styles.linkOutline}`} href="/peminjam/riwayat">Lihat riwayat peminjaman</Link>} /></div>;
}
